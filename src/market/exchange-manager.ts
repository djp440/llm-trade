...
export class ExchangeManager {
    ...
    public async testConnection(): Promise<void> {
        try {
            console.log(`[ExchangeManager] Testing connection to ${this.exchange.id}...`);
            
            // Fetch balance is a good way to test auth
            const balance = await this.exchange.fetchBalance();
            
            console.log(`[ExchangeManager] Connection successful!`);
            console.log(`[ExchangeManager] Account Balance (Total):`);
            ...
            console.error(`[ExchangeManager] Connection failed:`, error.message);
            throw error;
        }
    }
}
